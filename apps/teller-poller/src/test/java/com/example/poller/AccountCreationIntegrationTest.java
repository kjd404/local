...
public class AccountCreationIntegrationTest {
    ...
    void createsAndReusesAccountsFromFilename() throws Exception {
        Path file1 = copyResource("/com/example/poller/bank-1111.csv");
        ...
        Path file1b = copyResource("/com/example/poller/bank-1111.csv");
        ...
        Path file2 = copyResource("/com/example/poller/bank-2222.csv");
    ...
    void resolvesUsingDefaultsWhenFilenameMissing() throws Exception {
        Path file = copyResource("/com/example/poller/mystery.csv");
