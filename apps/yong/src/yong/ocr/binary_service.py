...
class BinaryOcrService(ReceiptOcrService):
    ...
    def __init__(
        ...
        *,
        ...
        runfile_location: str = "apps/yong/ocr_service_binary",
        ...
        alias_location = "apps/yong/ocr_service_binary"
        candidates: list[str] = []
        ...
        for fallback in (
            "apps/yong/mac_vision_ocr/ocr_service",
            "apps/yong/src/yong/ocr/paddle_ocr_service_bin",
        ):
