...
from plutary.ocr.paddle_service_bin import (
    InvocationError,
    OcrInvocation,
...
def _build_request_payload() -> str:
    image_path = _rlocation(
        "apps/plutary/src/test/resources/examples/sample_receipt_photo_01.jpeg"
    )
...
def test_paddle_service_binary_matches_golden() -> None:
    binary_path = _rlocation("apps/plutary/ocr_service_binary")
