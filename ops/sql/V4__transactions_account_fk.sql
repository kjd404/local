...
ALTER TABLE transactions
    ADD COLUMN account_id_new bigint;
...
FROM
    accounts a
WHERE
    a.external_id = t.account_id
    AND a.institution = t.source;
...
CREATE UNIQUE INDEX transactions_account_hash_idx ON transactions (account_id, hash);
